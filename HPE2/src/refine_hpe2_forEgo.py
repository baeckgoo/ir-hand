...
if __name__ == '__main__':
    ...
    trained_modelFile_hpe2='/home/yong/hdd/HPE2/output/2020_4_5_14_25/trainedModel_epoch99.pth.tar'
    
    args.gpu_ids='1'  #'0','1'
    args.use_net=['hpe1_orig','hpe2']
    args.train_net=['hpe2']
    ...
    #--HIG net setting
    if 'trained_modelFile_hig' in locals():
    ...
    datasetloader_uvr['train_ego']=datasetloader_UVR(dataset_path_uvr,traindataNum_ego,camera_info,'train_ego','generator')
    ...
    datasetloader_uvr['train_ego'].set_datasetLoader(args.train_batch)
    ...
    iternum_train_ego=traindataNum_ego//args.train_batch
    ...
    for epoch in range(args.epochs):
        ...
        datasetloader_uvr['train_ego'].shuffle()
        ...
        if traindataNum_ego>0:
            trange_num= int(((1+1)*traindataNum_ego)//args.train_batch)
            
        progressbar=trange(trange_num,leave=True)   
        for i in progressbar:
            #select dataset
            get_noblurdata,get_egodata=False,False
            ...
            if get_egodata==True:
                img_depth,img_ir=datasetloader_uvr['train_ego'].load_data()
