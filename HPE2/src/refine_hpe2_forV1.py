...
if __name__ == '__main__':
    ...
    args.lr_hpe2=1.0e-4#5.0e-6 #1.0e-5
    args.lr_hpd=1.0e-5
    args.weight_decay=1.0e-3#1.0e-4
    ...
    traindataNum_vr20=215*1  #vr dataset (no blur): 215
    
    validateNum=0       
    validateNum_vr20=2370   #vr test dataset: 2370 
