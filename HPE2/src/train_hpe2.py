...
if __name__ == '__main__':
    ...
    #trained_modelFile_hpe2='/home/yong/hdd/HPE2/output/2020_3_21_14_50/trainedModel_epoch92.pth.tar'
    ...
    for epoch in range(args.epochs):
        ...
        generator_train_icvl=datasetloader_icvl.generator_learningData(args.train_batch,'train',False,0)
        ...
        for i in progressbar:
            ...
            #print progress
            if i<(traindataNum_uvr//args.train_batch + traindataNum_blur_uvr//args.train_batch)-1:
                message='epc:%d: '%epoch
